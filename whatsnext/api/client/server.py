...
class Server:
    ...
    def append_project(self, *args, **kwargs):
        dummy_projects[random_string()] = {**kwargs, "last_updated": datetime.now(), "created_at": datetime.now()}

    def delete_project(self, project_name: str):
        print("Not implemented")

    def append_queue(self, project, job: Any):
        dummy_jobs[random_string()] = {**job, "project_id": project.id}
